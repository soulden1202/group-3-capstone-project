    ...
    <div className="fixed w-full h-full ">
      <div className=" bg-cover bg-homepageBg h-full w-full ">
          ...
          <div className="par flex justify-center items-center">
              <p style={parStyle}>At Livin it, we don't just show houses, we make dreams come true..</p>
          </div>
          <div className="p-3 flex justify-center items-center">
              <form action={"/property"}>
                  <button className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 
